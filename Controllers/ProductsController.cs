...
namespace DrugShop333.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductId,Name,RelaiseFromAndDosing,Amount,ShelfLife,Count,Price")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,Name,RelaiseFromAndDosing,Amount,ShelfLife,Count,Price")] Product product)
        {
